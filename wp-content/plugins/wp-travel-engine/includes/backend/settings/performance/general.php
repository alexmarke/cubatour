...
$lazy_loading = wptravelengine_settings()->get( "enable_lazy_loading", "inactive" ) ;
$map_lazy_loading = wptravelengine_settings()->get( "enable_map_lazy_loading", "inactive" ) ;
$img_lazy_loading = wptravelengine_settings()->get( "enable_img_lazy_loading", "inactive" ) ;
?>
...
<div class="wpte-field wpte-checkbox advance-checkbox">
	...
	<div class="wpte-checkbox-wrap">
		<input type="hidden" name="wp_travel_engine_settings[enable_optimize_loading]" value="inactive" >
		<input type="checkbox" id="wp_travel_engine_settings[enable_optimize_loading]" name="wp_travel_engine_settings[enable_optimize_loading]" value="active" <?php checked( $optimized_loading, 'active' ); ?>>
...
<div class="wpte-field wpte-checkbox advance-checkbox">
	...
	<div class="wpte-checkbox-wrap">
		<input type="hidden" name="wp_travel_engine_settings[enable_lazy_loading]" value="inactive" >
		<input type="checkbox" id="wp_travel_engine_settings[enable_lazy_loading]"
		name="wp_travel_engine_settings[enable_lazy_loading]" value="active"
		data-onchange
		data-onchange-toggle-target="[data-enable-lazy-loading]"
		data-onchange-toggle-off-value="no"
		<?php checked( $lazy_loading, 'active' ); ?>>
...
<div class="wpte-field-subfields<?php echo 'active' === $lazy_loading ? '' : ' hidden'; ?>" data-enable-lazy-loading>
...
<div class="wpte-field wpte-checkbox advance-checkbox">
	...
	<div class="wpte-checkbox-wrap">
		<input type="hidden" name="wp_travel_engine_settings[enable_map_lazy_loading]" value="inactive" >
		<input type="checkbox" id="wp_travel_engine_settings[enable_map_lazy_loading]"
		name="wp_travel_engine_settings[enable_map_lazy_loading]" value="active"
		<?php checked( $map_lazy_loading, 'active' ); ?>>
...
<div class="wpte-field wpte-checkbox advance-checkbox">
	...
	<div class="wpte-checkbox-wrap">
		<input type="hidden" name="wp_travel_engine_settings[enable_img_lazy_loading]" value="inactive" >
		<input type="checkbox" id="wp_travel_engine_settings[enable_img_lazy_loading]"
		name="wp_travel_engine_settings[enable_img_lazy_loading]" value="active"
		data-onchange
		data-onchange-toggle-target="[data-enable-img-lazy-loading]"
		data-onchange-toggle-off-value="no"
		<?php checked( $img_lazy_loading, 'active' ); ?>>
