...
`,vi=({children:e,title:t,...n})=>(0,r.createElement)(mi,null,(0,r.createElement)(hi,{className:"wc__tooltip",content:t,disabled:!t,animation:"shift-away",arrow:!0,...n},e)),bi=({content:e,children:t,className:n,interactive:o,...i})=>{const a=`cw_popover ${n}`;return(0,r.createElement)(hi,{content:e,className:a,trigger:"click",theme:"light",disabled:!e,animation:"shift-away",interactive:!0,allowHTML:!0,arrow:!0,...o?{}:{appendTo:document.body},...i},(0,r.createElement)("div",null,t))},wi=ar.div`
...
`,Ei=({title:e,changed:t,children:n,...o})=>(0,r.createElement)(vi,{title:e},(0,r.createElement)(_i,{type:"button",className:1===t?"changed":"",...o},n||Ci.pen)),ki=(ar.div`
    padding: 8px 16px;
    font-size: 12px;
    color: #717578;
...
`,Mi=ar.i`
    margin: 0 8px;
`,Si=({device:e,onChange:t})=>(0,r.createElement)(Oi,{className:"cw__responsive-buttons"},(0,r.createElement)("button",{className:"cw__responsive-button"+("desktop"===e?" active":""),onClick:()=>t("desktop"),title:"Desktop"},Ci.desktop),(0,r.createElement)("button",{className:"cw__responsive-button"+("tablet"===e?" active":""),onClick:()=>t("tablet"),title:"Tablet"},Ci.tablet),(0,r.createElement)("button",{className:"cw__responsive-button"+("mobile"===e?" active":""),onClick:()=>t("mobile"),title:"Mobile"},Ci.mobile)),Ai=e=>({direction:t,className:n,label:o,divider:i,description:a,value:l,defaultValue:c,onChange:s,responsive:d,isChildren:u,visibility:p,setVisibility:f,help:h,children:g,hideResetButton:m=!0,containerStyle:v,...b})=>{let w=(0,gi.useRef)(null);null==w.current&&(w.current=l);const[x,y]=(0,gi.useState)("desktop"),C=JSON.stringify(c||w.current),_=JSON.stringify(l);return(0,r.createElement)(ki,{className:`cw__control-item ${t||""} ${n||""}`,"data-visibility":!!p&&"hidden","data-divider":i},o&&(0,r.createElement)("header",null,(0,r.createElement)("label",null,o,h&&(0,r.createElement)(vi,{title:h},(0,r.createElement)(Mi,null,Ci.help))),(p||!m&&!u&&C!==_||d)&&(0,r.createElement)("div",{className:"cw__action-buttons"},!m&&(0,r.createElement)(r.Fragment,null,!u&&C!==_&&(0,r.createElement)("button",{tabIndex:0,className:"cw__reset-button",onClick:()=>s(w.current)},"Reset")),d&&(0,r.createElement)(Si,{onChange:y,device:x}),p&&(0,r.createElement)("button",{className:"cw__visibility-button",onClick:()=>{f(!p)}},"Visibility"))),a&&"horizontal"!==t&&(0,r.createElement)("div",{className:"cw__control-description"},a),(0,r.createElement)("section",{className:n||"",style:v},(0,r.createElement)(e,{changed:C!==_?1:0,value:d?l[x]:l,onChange:e=>{return t=e,void s(d?{...l,[x]:t}:t);var t},...b}),g),a&&"horizontal"===t&&(0,r.createElement)("div",{className:"cw__control-description",style:{margin:"16px 0 0"}},a))},Di={close:(0,r.createElement)("svg",{width:"9",height:"10",viewBox:"0 0 9 10",fill:"none",xmlns:"http://www.w3.org/2000/svg"},(0,r.createElement)("path",{d:"M8.12428 1.46449L1.05321 8.53556M1.05321 1.46449L8.12428 8.53556",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"}))},Li=ar.div`
	position: relative;
	font-size: 14px;
	min-width: 136px;
	[data-tippy-root]{
...
`,Ti=({value:e,options:t=[],isSearchable:n,onSelect:o,onSearch:a})=>(0,r.createElement)("div",{className:"cw__select-dropdown"},n&&(0,r.createElement)("input",{type:"search",placeholder:(0,i.__)("Search...","Rishi"),onChange:a}),t.length<=0&&(0,r.createElement)("span",{className:"cw__404-text"},"There are no options!"),(0,r.createElement)("ul",{className:"cw__select-options"},t?.map((({value:t,label:n,icon:i},a)=>{const l=e==t;return(0,r.createElement)("li",{key:a,tabIndex:0,className:l?"selected":"",onClick:o(t),onKeyDown:o(t)},i&&(0,r.createElement)("i",{className:"icon"},i),(0,r.createElement)("span",{className:"text"},n))})))),Ni=(e,t)=>e?.filter((e=>t?.indexOf(e.value)<0)),Bi=({onChange:e,onCancelClick:t,options:n,value:o,isMultiple:i,isSearchable:a,isSortable:l=!1,placeholder:c,variant:s,style:d,disabled:u=!1})=>{const[p,f]=(0,gi.useState)(!1),h=(0,gi.useRef)(null),g=n?.find((e=>e.value==o)),m=p||n;(0,gi.useEffect)((()=>{i&&o.length>0&&f(Ni(n,o))}),[o]);const v=l?Hi:"div";return(0,r.createElement)(Li,{className:`${i?" is-multiple":""} ${s||""}`,disabled:u},(0,r.createElement)(hi,{content:(0,r.createElement)(Ti,{value:o,isSearchable:a,options:m,onSelect:t=>n=>{("click"===n.type||"keydown"===n.type&&"Enter"===n.key)&&(e(i?o.includes(t)?o.filter((e=>e!=t)):[...o,t]:t),h.current.focus())},onSearch:e=>{const t=e.target.value.toLowerCase();f(i?Ni(n,o).filter((e=>e.label.toLowerCase().match(t))):n.filter((e=>e.value.toLowerCase().split("-").join(" ").match(t))))}}),animation:"shift-away",trigger:"click",arrow:!1,interactive:!0,disabled:u},(0,r.createElement)("div",{className:"cw__custom-select "+(u?"disabled":"")},(0,r.createElement)("div",{tabIndex:0,className:"cw__custom-select__input-wrapper",ref:h,style:d},i&&(0,r.createElement)(v,{className:l?"":"cw__badge-container",style:{padding:"0px"},items:o,setItems:e},o?.map(((i,a)=>{const l=n?.find((e=>e.value===i))?.label;return(0,r.createElement)(Pi,{key:i,id:i,text:l,onCancel:()=>{t?t(i):e(o?.filter((e=>e!==i)))}})}))),!i&&(0,r.createElement)("span",{className:"cw__custom-select__input-value"},g?.icon,g?.label),c&&o?.length<=0&&(0,r.createElement)("span",{className:"placeholder"},c||"Select")))))},ji=e=>Ai(Bi)(e),Pi=e=>{const{attributes:t,listeners:n,setNodeRef:o,transform:i,transition:a}=St({id:e.id}),{children:l}=e,c={transform:L.Transform.toString(i),transition:a};return(0,r.createElement)(Ri,{style:c,ref:o,...t},(0,r.createElement)("span",{title:e?.text,className:"cw__selected-badge",...n},e?.text),(0,r.createElement)("button",{type:"button","aria-label":"cancel",className:"cw__cancel",onClick:e?.onCancel},Di.close))},Hi=({children:e,items:t,setItems:n})=>{const o=function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return(0,r.useMemo)((()=>[...t].filter((e=>null!=e))),[...t])}(Z(Ne),Z(Ae,{coordinateGetter:Lt}));return(0,r.createElement)(ut,{sensors:o,collisionDetection:G,onDragEnd:e=>{const{active:t,over:r}=e;t.id!==r.id&&n((e=>{const n=e.indexOf(t.id),o=e.indexOf(r.id);return gt(e,n,o)}))}},(0,r.createElement)(yt,{items:t},e))},Vi=({onChange:e,...t})=>(0,r.createElement)("input",{type:"text",onChange:t=>e(t.target.value),...t}),Ii=e=>Ai(Vi)(e),zi=({onChange:e,...t})=>(0,r.createElement)("textarea",{onChange:t=>e(t.target.value),...t}),Wi=e=>Ai(zi)(e),Zi=ar.div`
    width: 40px;
    height: 22px;
    border-radius: 45px;
...
`,Fi=({onChange:e,value:t})=>(0,r.createElement)(Zi,{tabIndex:0,className:"cw__switch"+(t?" checked":""),onClick:()=>e(!t),onKeyDown:n=>{"keydown"===n.type&&"Enter"===n.key&&e(!t)}},(0,r.createElement)("span",null)),$i=e=>Ai(Fi)({...e,hideResetButton:!0,direction:"horizontal"}),Ui=ar.label`
  display: inline-flex;
  align-items: center;
  justify-content: center;
  position: relative;
...
`,Yi=ar.ul`
    ...
    ${e=>e.inline&&"\n    flex-direction: row;\n  "}
`,Xi={sm:"14px",md:"16px",lg:"18px",xl:"20px"},Ki=({value:e,label:t,checked:n,icon:o,onChange:i,title:a,size:l,...c})=>{const{style:s,...d}={...c};return(0,r.createElement)(vi,{title:a},(0,r.createElement)(Ui,{tabIndex:0,className:"cw__select-button"+(n?" cw__select-button-checked":""),onKeyDown:t=>{"keydown"===t.type&&"Enter"===t.key&&i(e)},style:{fontSize:Xi[l],...s}},(0,r.createElement)("span",{className:"cw__select-button"},(0,r.createElement)("input",{tabIndex:-1,className:"cw__select-button-input",type:"checkbox",value:e,checked:n,onChange:i,...d})),o&&(0,r.createElement)("span",{className:"cw__icon"},o),t&&(0,r.createElement)("span",null,t)))},Gi=({options:e,className:t,onChange:n,value:o,separate:i,isMultiple:a,size:l,type:c,inline:s,...d})=>{const u=e=>()=>{n(a?o.includes(e)?o.filter((t=>t!=e)):[...o,e]:e)};return"radio"==c?(0,r.createElement)(Yi,{inline:s},e?.map((({value:e,label:t,id:i,...a},l)=>(0,r.createElement)("li",{key:l},(0,r.createElement)("label",{htmlFor:i},(0,r.createElement)("input",{type:"radio",checked:o===e,id:i,...a,onChange:()=>n(e)}),t))))):(0,r.createElement)(qi,{className:`cw__select-button-group ${t||""} ${i?"cw__separate":""} ${l||""}`},e.map((({value:e,...t},n)=>{const i=a?o.includes(e):o===e,{...c}={...d,...t};return(0,r.createElement)(Ki,{key:n,size:l,value:e,checked:i,onChange:u(e),...c})})))},Ji=e=>Ai(Gi)({...e,direction:!1}),Qi=window.lodash,ea=e=>{var t;return(0,Qi.isString)(e)?null!==(t=e?.match(/(\px|em|pt|vw|vh|rem|%|cm|mm|Q|in|pc)/g))&&void 0!==t?t:[]:e},ta=new RegExp(/([-+]?([0-9]*\.[0-9]+|[0-9]+))(px|em|pt|vw|vh|rem|%|cm|mm|Q|in|pc)?/),na=ar.div`
    display: flex;
...
`,ra=[{unit:"px",min:0,max:1e3},{unit:"em",min:0,max:20},{unit:"rem",min:0,max:20},{unit:"%",min:0,max:100},{unit:"pt",min:0,max:100}],oa=({units:e,value:t,min:n,max:o,onChange:i,className:a,...c})=>{var s;const[,d="",,u=""]=null!==(s=t?.match(ta))&&void 0!==s?s:[];let p=ra.find((e=>e.unit==t))?"":d,f=ra.find((e=>e.unit==t))?t:u;e=(0,Qi.isBoolean)(e)&&(e?ra:e)||e,n=!(0,Qi.isBoolean)(e)&&e?.find((e=>e.unit===f))?.min||n||0,o=!(0,Qi.isBoolean)(e)&&e?.find((e=>e.unit===f))?.max||o||1e3,e=!(0,Qi.isBoolean)(e)&&e?.map((e=>e?.unit))||e;const h=(e,t)=>{e>=o?e=o:e<=n&&(e=n),i(e+t)};return(0,r.createElement)(na,{className:f||e?"cw__has-unit":""},(0,r.createElement)(l.RangeControl,{value:Number(p)||"",onChange:e=>h(e,f),min:n,max:o,...c}),(f||e)&&(0,r.createElement)(yi,{units:e,value:f,onChange:e=>h(p,e)}))},ia=e=>Ai(oa)(e),aa=ar.div`
...
`,la=({color:e,title:t,children:n,interactive:o})=>(0,r.createElement)(aa,{className:"cw__color-picker-trigger",color:e},(0,r.createElement)(bi,{content:n,interactive:o,placement:"left"},(0,r.createElement)(vi,{title:t},(0,r.createElement)("span",{tabIndex:0,className:"cw__color-picker-color-block"},(0,r.createElement)("span",{className:"cw__color-picker-color-block-inner"}))))),ca=ar.header`
  padding: 5px;
  border: 1px solid var(--cw__border-color);
  border-radius: var(--cw__border-radius);
  margin: 0 -4px 13px;
...
`,sa=({colorPalette:e,value:t,title:n,interactive:o,onChange:i,...a})=>{let c=t;if(t?.includes("var(")){const e=t.replace(/var[()]/g,"").replace(/[)]/g,"");c=getComputedStyle(document.body).getPropertyValue(e)}return(0,r.createElement)(la,{color:t,title:n,interactive:o},e&&(0,r.createElement)(ca,null,(0,r.createElement)(l.ColorPalette,{colors:e,value:c,clearable:!1,disableCustomColors:!0,onChange:t=>{const n=e.find((e=>e.color===t))?.slug;i(`var(${"--wp--preset--color--"+n})`)},...a})),(0,r.createElement)(l.ColorPicker,{color:c,enableAlpha:!0,defaultValue:"#000",onChange:i,...a}))},da=e=>Ai(sa)(e),ua=ar.div`
  display: flex;
  flex-wrap: wrap;
  gap: 4px;
`,pa=({colors:e,value:t,onChange:n,...o})=>(0,r.createElement)(ua,null,e?.map((({title:e,name:i,colorPalette:a},l)=>(0,r.createElement)(da,{key:l,value:t[i],title:e,colorPalette:a,onChange:e=>n({...t,[i]:e}),...o})))),fa=e=>Ai(pa)(e),ha=(ar.div`
  padding: 10px;
  border: 1px solid var(--cw__border-color);
  border-radius: var(--cw__border-radius);
  display: flex;
...
`,ma=[{name:"top",label:"Top"},{name:"right",label:"Right"},{name:"bottom",label:"Bottom"},{name:"left",label:"Left"}],va=(e,t)=>{let n={};return ma.map((({name:r})=>{const o="auto"!==t[r];n={...n,[r]:o?e:t[r]}})),n},ba=[{unit:"px",min:0,max:1e3},{unit:"em",min:0,max:20},{unit:"rem",min:0,max:20},{unit:"%",min:0,max:100},{unit:"pt",min:0,max:100}],wa=({label:e,value:t,...n})=>{const o="auto"!=t;return(0,r.createElement)(ha,{className:"cw__spacing-input-wrapper"},(0,r.createElement)("span",{className:"cw__spacing-input"},(0,r.createElement)("input",{readOnly:!o,type:o?"number":"text",value:t,...n})),e&&(0,r.createElement)("span",{className:"label"},e))},xa=({onChange:e,value:t,units:n,...o})=>{const[i,a]=(0,gi.useState)(!0);n=(0,Qi.isBoolean)(n)?ba:n;const l=Object.values(t).find((e=>""!==e&&"auto"!==e))||"",[c="px"]=ea(l),s=n?.find((e=>e.unit===c)),d=s?.max||1e3,u=s?.min||0,p=Object.values(t).find((e=>""!==e&&"auto"!==e))||0+c,f=n=>{const r=n.target.value,o=n.target.name;if("number"===n.target.type){const n=""!==r?r>=d?d:r<=u?u:r:r;e(i?{...t,...va(n+c,t)}:{...t,[o]:n+c})}};return n=n?.map((e=>e.unit)),(0,r.createElement)(ga,{className:"cw__spacing-group"},ma.map((({name:e,label:n})=>{let i=t[e];if(ea(t[e]).length>0){var a;const[,n]=(null!==(a=t[e])&&void 0!==a?a:"")?.match(ta)||[];i=n}return(0,r.createElement)(wa,{key:e,label:n,name:e,onChange:f,value:i,...o})})),(0,r.createElement)("div",{className:"cw__spacing-button-wrapper"},(0,r.createElement)("button",{type:"button",className:"cw__spacing-button-link-button"+(i?" active":""),onClick:()=>(a(!i),void e({...t,...va(p,t)}))},Ci.link),(0,r.createElement)(yi,{units:n,value:c,onChange:n=>(n=>{let r={};Object.entries(t).map((([e,t="0px"])=>{var o;const[,i]=null!==(o=t?.match(/(\d+)/))&&void 0!==o?o:[];""!==t&&(r={...r,[e]:i+n})})),e({...t,...r})})(n)})))},ya=e=>Ai(xa)(e),Ca=(ar.div`
    .components-button {
        min-height: 43px;
        display: flex;
        align-items: center;
...
`),_a=({value:e,min:t,max:n,onChange:o,step:i,...a})=>{const l=i||1;return(0,r.createElement)(Ca,{className:"cw__input-number-wrapper"},(0,r.createElement)("button",{disabled:t>=e,type:"button",onClick:()=>{o(+e-l)}},Ci.minus),(0,r.createElement)("input",{type:"number",value:+e,onChange:e=>o(e.target.value),min:t,max:n,...a}),(0,r.createElement)("button",{disabled:n<=e,type:"button",onClick:()=>{o(+e+l)}},Ci.plus))},Ea=e=>Ai(_a)({...e,direction:"horizontal"}),ka=ar.div`
    display: inline-flex;
    align-items: center;
    gap: 8px;
`,Oa=({value:e,onChange:t})=>{const{width:n,style:o}=e;return(0,r.createElement)(r.Fragment,null,(0,r.createElement)(Ea,{label:"Border Width",direction:"horizontal",value:n,onChange:n=>t({...e,width:n}),min:0,isChildren:!0}),(0,r.createElement)(ji,{label:"Border Style",options:[{value:"none",label:"None",icon:Ci.none},{value:"solid",label:"Solid",icon:Ci.minus},{value:"dashed",label:"Dash",icon:Ci.dashed},{value:"double",label:"Double",icon:Ci.menu},{value:"dotted",label:"Dot",icon:Ci.ellipsis}],value:o,onChange:n=>t({...e,style:n}),isChildren:!0}))},Ma=({colorPalette:e,changed:t,value:n,onChange:o,...i})=>{const{color:a}=n;return(0,r.createElement)(ka,null,(0,r.createElement)(da,{colorPalette:e,title:"Border Color",value:a,onChange:e=>o({...n,color:e}),...i}),(0,r.createElement)(bi,{content:(0,r.createElement)(Oa,{value:n,onChange:o,...i})},(0,r.createElement)(Ei,{changed:t})))},Sa=e=>Ai(Ma)({...e,direction:"horizontal"}),Aa=ar.div`
...
`,Da=ar.div`
  ...
  align-items: center;
  gap: 8px;
`,La=({value:e,onChange:t})=>{const{enable:n,xOffset:o,yOffset:i,blur:a,spread:l,position:c}=e;return(0,r.createElement)(Aa,null,(0,r.createElement)($i,{label:"Enable",direction:"horizontal",value:n,onChange:n=>t({...e,enable:n}),isChildren:!0}),(0,r.createElement)(ia,{label:"Horizontal",value:o||"0px",onChange:n=>t({...e,xOffset:n}),min:-100,max:100,isChildren:!0}),(0,r.createElement)(ia,{label:"Vertical",value:i||"0px",onChange:n=>t({...e,yOffset:n}),min:-100,max:100,isChildren:!0}),(0,r.createElement)(ia,{label:"Blur",value:a||"0px",onChange:n=>t({...e,blur:n}),min:0,max:100,className:"cw__box-shadow-blur",isChildren:!0}),(0,r.createElement)(ia,{label:"Spread",value:l||"0px",onChange:n=>t({...e,spread:n}),min:-100,max:100,isChildren:!0}),(0,r.createElement)(Ji,{label:"Position",options:[{value:"outline",label:"Outline"},{value:"inset",label:"Inset"}],value:c,onChange:n=>t({...e,position:n}),isChildren:!0}))},Ra=({colorPalette:e,value:t,onChange:n,changed:o,...i})=>{const{color:a}=t;return(0,r.createElement)(Da,null,t?.enable&&(0,r.createElement)(da,{colorPalette:e,value:a,onChange:e=>n({...t,color:e}),isChildren:!0}),(0,r.createElement)(bi,{content:(0,r.createElement)(La,{value:t,onChange:n})},(0,r.createElement)(Ei,{changed:o})))},Ta=e=>Ai(Ra)({...e,direction:"horizontal"}),Na=({value:e,onChange:t,responsiveState:n,setResponsiveState:o,fontFamilies:i,fontWeights:a})=>{const{family:l="default",size:c={desktop:"px",tablet:"px",mobile:"px"},"line-height":s={desktop:"",tablet:"",mobile:""},"letter-spacing":d={desktop:"0px",tablet:"0px",mobile:"0px"},weight:u="400",style:p="inherit",transform:f="inherit",decoration:h="inherit"}=e,g=(n,r)=>{t({...e,[n]:r})};return(0,r.createElement)(r.Fragment,null,(0,r.createElement)(ji,{label:"Font Family",direction:"horizontal",value:l||"default",onChange:e=>g("family",e),options:i||[{label:"Default",value:"default"}],placeholder:"Select Font Family",variant:"solid",isChildren:!0,isSearchable:!0,style:{width:"136px"},disabled:!0}),(0,r.createElement)(ia,{label:"Size",value:c,onChange:e=>g("size",e),isChildren:!0,responsive:!0,units:[{unit:"px",min:0,max:100},{unit:"em",min:0,max:20},{unit:"rem",min:0,max:20}]}),(0,r.createElement)(ia,{label:"Line Height",value:s,onChange:e=>g("line-height",e),isChildren:!0,responsive:!0,step:.1,min:0,max:10,units:[{unit:"px",min:0,max:100},{unit:"em",min:0,max:20}]}),(0,r.createElement)(ia,{label:"Letter Spacing",value:d,onChange:e=>g("letter-spacing",e),isChildren:!0,responsive:!0,units:[{unit:"px",min:0,max:100},{unit:"em",min:0,max:20}],step:.1}),a&&(0,r.createElement)(ji,{label:"Font Weight",direction:"horizontal",value:u,options:a||[],onChange:e=>g("weight",e),variant:"solid",isChildren:!0,style:{width:"136px"}}),(0,r.createElement)(ji,{label:"Style",direction:"horizontal",options:[{value:"inherit",label:"Inherit"},{value:"italic",label:"Italic"},{value:"oblique",label:"Oblique"},{value:"normal",label:"Normal"}],value:p,onChange:e=>g("style",e),variant:"solid",isChildren:!0,style:{width:"136px"}}),(0,r.createElement)(ji,{label:"Transform",direction:"horizontal",options:[{value:"inherit",label:"Inherit"},{value:"uppercase",label:"Uppercase"},{value:"lowercase",label:"Lowercase"},{value:"capitalize",label:"Capitalize"},{value:"none",label:"None"}],value:f,onChange:e=>g("transform",e),variant:"solid",isChildren:!0,style:{width:"136px"}}),(0,r.createElement)(ji,{label:"Decoration",direction:"horizontal",options:[{value:"inherit",label:"Inherit"},{value:"underline",label:"Underline"},{value:"overline",label:"Overline"},{value:"line-through",label:"Line Through"},{value:"none",label:"None"}],value:h,onChange:e=>g("decoration",e),variant:"solid",isChildren:!0,style:{width:"136px"}}))},Ba=({changed:e,...t})=>(0,r.createElement)(bi,{content:(0,r.createElement)(Na,{...t}),placement:"left"},(0,r.createElement)(Ei,{changed:e})),ja=e=>Ai(Ba)({...e,direction:"horizontal"}),Pa=(ar.div`
  .cw__control-item {
    &.cw__divider-top {
      margin-top: 12px;
      padding-top: 12px;
...
`),Ha=e=>(0,r.createElement)(Pa,null,(0,r.createElement)(l.FormTokenField,{...e})),Va=e=>Ai(Ha)(e),Ia=(ar.div`
    margin-bottom: 16px;
